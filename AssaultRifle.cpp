...
/// 弾丸情報の初期化
/// </summary>
void AssaultRifle::InitializeBulletData(VECTOR targetVector)
{
...
/// 更新
/// </summary>
void AssaultRifle::Update(VECTOR setPosition, VECTOR cameraVector, VECTOR cameraTargetVector, float cameraPitch)
{
    // 座標を更新
