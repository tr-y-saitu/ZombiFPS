...
void ModelDataManager::ModelDataLoad()
{
    ...
    modelDataList[BattleRifleModelData]     = MV1LoadModel("Data/Gun/Barret/barretCross.mv1");
    modelDataList[AssaultRifleModelData]    = MV1LoadModel("Data/Gun/AR15/AR-15Custom.mv1");
}
