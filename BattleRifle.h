...
private:
    ...
    // ステータス
    // 弾丸
    static constexpr float  BulletDamagePower       = 75.0f;       // 弾丸の威力
    ...
    static constexpr VECTOR InitializeScale         = { 0.06f,0.06f,0.06f };    // 初期化時のスケール
    static constexpr int    MaxBackUpAmmo           = 50;          // 銃の最大予備弾薬数
    // 強化時
